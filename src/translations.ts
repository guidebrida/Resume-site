...
const translations: Translations = {
    en: {
        ...
        skills: {
            ...
            categories: [
                { name: 'Backend Languages', skills: ['Java', 'Spring Boot', 'JavaEE', 'C#', 'Kotlin'] },
                { name: 'Frontend Development', skills: ['Angular', 'AngularJS', 'React', 'jQuery', 'JSP'] },
                { name: 'Cloud & DevOps', skills: ['AWS', 'Azure DevOps', 'Docker', 'Kubernetes', 'Jenkins'] },
                { name: 'Database & Integration', skills: ['SQL', 'JDBC', 'Hibernate', 'Kafka', 'Git'] },
                { name: 'Testing & Best Practices', skills: ['JUnit', 'Mockito', 'CI/CD', 'JWT', 'REST APIs'] },
                { name: 'Languages', skills: ['Portuguese (Native)', 'English (C1)'] },
            ],
        },
    ...
    pt: {
        ...
        skills: {
            ...
            categories: [
                { name: 'Linguagens Backend', skills: ['Java', 'Spring Boot', 'JavaEE', 'C#', 'Kotlin'] },
                { name: 'Desenvolvimento Frontend', skills: ['Angular', 'AngularJS', 'React', 'jQuery', 'JSP'] },
                { name: 'Cloud & DevOps', skills: ['AWS', 'Azure DevOps', 'Docker', 'Kubernetes', 'Jenkins'] },
                { name: 'Banco de Dados & Integração', skills: ['SQL', 'JDBC', 'Hibernate', 'Kafka', 'Git'] },
                { name: 'Testes & Boas Práticas', skills: ['JUnit', 'Mockito', 'CI/CD', 'JWT', 'REST APIs'] },
                { name: 'Idiomas', skills: ['Português (Nativo)', 'Inglês (C1)'] },
            ],
        },
...
// Expõe no window para acesso global (compatibilidade com o HTML existente)
